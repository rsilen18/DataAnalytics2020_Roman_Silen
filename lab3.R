setwd("/Users/silenr/Documents/CSCI-4960/lab3")
library(rpart)
library(rpart.plot)
library(ggplot2)
data("msleep")
str(msleep)
str(data)
# create new dataframe w/ following cols included
...
rpart.plot(sleepModel_1, type=3, digits=3, fallen.leaves=TRUE) # w/ 3 digits
...
irisrand <- iris[order(grn),]  # shuffles dataset
str(irisrand)
...
# plot classification model tree
